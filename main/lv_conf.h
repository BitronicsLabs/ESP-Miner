...
// Don't use custom memory pool - let LVGL use standard malloc() which automatically
// uses available memory (PSRAM if present, internal RAM otherwise)
// This prevents crashes on devices without PSRAM
